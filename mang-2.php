...
if(isset($_POST["button_tinh"]) && $_POST["so_phan_tu"] > 0)
{
    $n = $_POST["so_phan_tu"];
        ...
        for($i=0;$i<$n;$i++){
            ...
            $so_ngau_nhien=mt_rand(0,20);
            $mang_so[$i]=$so_ngau_nhien;
    
        }
function xuat_mang($mang_so){
    $mang_phat_sinh = implode(" ", $mang_so);
    echo $mang_phat_sinh;
    }
        ...
        <table>
            ...
            <tbody>
                <tr>
                    ...
                    <td><input type="text" name="so_phan_tu" value="<?php echo $n ?>" width="100%" ></td>
                </tr>
                <tr>
                    <td></td>
                    <td><input type="submit" value="Phát sinh và tính toán" name="button_tinh"></td>
                </tr>
                <tr>
                    <td>Mảng: </td>
